        ...
        <div class="card-body">
            ...
            <form action="{{ route('post.update', $post->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ old('title', $post->title) }}" id="title"
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button class="btn btn-md btn-primary" type="submit">Edit Post</button>
                </div>
                @isset($post->featured_image)
                    <img class="w-100 mt-3" src="{{ asset('storage/' . $post->featured_image) }}" alt="">
                @endisset
